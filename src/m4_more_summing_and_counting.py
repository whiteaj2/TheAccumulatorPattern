...
def test_count_cosines_from():
    ...
    expected = 0
    answer = count_cosines_from(3, 4, 0.3)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    expected = 1
    answer = count_cosines_from(7, 9, 0.5)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    expected = 2
    answer = count_cosines_from(4, 6, 0.25)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
...
def test_sum_unit_fractions_from():
    ...
    expected = 0.9603 # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(16, 40)
    print('Test 1 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
